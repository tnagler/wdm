...
inline void
check_sizes(const std::vector<double>& x,
...
pow(const std::vector<double>& x, size_t n)
{
...
inline double
perm_sum(const std::vector<double>& x, size_t k)
{
  if (k == 0)
    return 1.0;
  double s = 0;
...
inline double
effective_sample_size(size_t n, const std::vector<double>& weights)
{
  double n_eff;
  if (weights.size() == 0) {
...
inline std::vector<size_t>
get_order(const std::vector<double>& x, bool ascending = true)
{
  size_t n = x.size();
...
inline double
count_ties_v(const std::vector<double>& x, const std::vector<double>& weights)
{
...
inline double
count_tied_pairs(const std::vector<double>& x,
                 const std::vector<double>& weights)
{
  bool weighted = (weights.size() > 0);
  double count = 0.0, w1 = 0.0, w2 = 0.0;
...
inline double
count_tied_triplets(const std::vector<double>& x,
                    const std::vector<double>& weights)
{
  bool weighted = (weights.size() > 0);
...
inline double
count_joint_ties(const std::vector<double>& x,
                 const std::vector<double>& y,
                 const std::vector<double>& weights)
{
  bool weighted = (weights.size() > 0);
...
inline void
merge_sort(std::vector<double>& vec,
           std::vector<double>& weights,
           double& count)
{
  if (vec.size() > 1) {
