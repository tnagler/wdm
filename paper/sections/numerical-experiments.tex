...
$n\in\{50,100,200,500\}$.  Null rejection probabilities use 2000 replications
at each combination of sample size and weight profile; power uses 1000
...
not support ties.  The complete default study ran single-threaded in 50 seconds
on the reference machine.

\subsection{Null calibration}

\input{simulation/results/null-size}
...
Monte Carlo standard error of $0.0049$.  Unequal weighting does not create a
...
$0.096$ at $n=50$, but approaches the nominal level as $n$ increases.
Unequal-weight Hoeffding is mildly liberal at $n=50$ and $100$, with rejection
probabilities $0.067$ and $0.072$, and is close to nominal from $n=200$ onward.
At $n=500$, all entries lie between $0.035$ and $0.056$.

\subsection{Power}

\input{simulation/results/power}
...
from $0.427$ at $n=50$ to $0.957$ at $n=200$, followed closely by Spearman and
...
Hoeffding's $D$ and Chatterjee's $\xi$ attain power $0.927$ and $0.779$, while
Spearman, Kendall, and Blomqvist remain between $0.060$ and $0.080$ because
